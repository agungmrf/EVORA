...
{
    public partial class AccountCek : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sub_district_guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    name = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    province_guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    district_guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    customer_guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    package_event_guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    location_guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
