...
const baseUrl = "https://localhost:52115/api/province/";
...
$(document).ready(() => {
        ...
        columns: [
            ...
            },
            {
                render: (data, type, row) => {
                    return `
                    <button type="button" class="btn btn-sm btn-primary" onclick="edit('${row.guid}')"  data-bs-toggle="modal" data-bs-target="#modal-provinces">
                       <span>
    ...
    $(".btn-input").on("click", function () {
        ...
        $("#modal-provinces .modal-title").html("Add New Provinces");

        $("#modal-provinces button[type=submit]").removeClass("btn-edit");
    });
    ...
    edit = function (id) {
        ...
        $.ajax({
            ...
            $("#modal-provinces .modal-title").html("Edit Province");

            $("#modal-provinces button[type=submit]").addClass("btn-edit");
        }).fail((error) => {
            console.log(error);
        })
    }
    ...
    const form = document.querySelector('#form-provinces');
